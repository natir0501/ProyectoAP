...
const cargaPantallas = async () => {
    ...
    if (pantallas.length === 0) {
        ...
        await new Pantalla({ 'nombre': 'Informe de Pago', 'menu': 'Jugador', 'opcionMenu': 'Informe de Pago', 'componente': 'RegistroPagoCuotaPage', 'roles': [delegadoInst._id, jugador._id,] }).save()
